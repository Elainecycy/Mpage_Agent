...
import { restaurantConfig, localConfig } from './configs/configs.js';
...
let A2UILayoutEditor = (() => {
    ...
    let _private_isLocalMode_decorators;
    let _private_isLocalMode_initializers = [];
    let _private_isLocalMode_extraInitializers = [];
    let _private_isLocalMode_descriptor;
    let _private_localFileName_decorators;
    let _private_localFileName_initializers = [];
    let _private_localFileName_extraInitializers = [];
    let _private_localFileName_descriptor;
    let _private_toastMessage_decorators;
    let _private_toastMessage_initializers = [];
    let _private_toastMessage_extraInitializers = [];
    let _private_toastMessage_descriptor;
    let _private_toastType_decorators;
    let _private_toastType_initializers = [];
    let _private_toastType_extraInitializers = [];
    let _private_toastType_descriptor;
    let _snackbar_decorators;
    let _snackbar_initializers = [];
    let _snackbar_extraInitializers = [];
    var A2UILayoutEditor = class extends _classSuper {
        ...
        static {
            ...
            _private_isLocalMode_decorators = [state()];
            _private_localFileName_decorators = [state()];
            _private_toastMessage_decorators = [state()];
            _private_toastType_decorators = [state()];
            _snackbar_decorators = [query('ui-snackbar')];
            ...
            __esDecorate(this, _private_isLocalMode_descriptor = { get: __setFunctionName(function () { return this.#isLocalMode_accessor_storage; }, "#isLocalMode", "get"), set: __setFunctionName(function (value) { this.#isLocalMode_accessor_storage = value; }, "#isLocalMode", "set") }, _private_isLocalMode_decorators, { kind: "accessor", name: "#isLocalMode", static: false, private: true, access: { has: obj => #isLocalMode in obj, get: obj => obj.#isLocalMode, set: (obj, value) => { obj.#isLocalMode = value; } }, metadata: _metadata }, _private_isLocalMode_initializers, _private_isLocalMode_extraInitializers);
            __esDecorate(this, _private_localFileName_descriptor = { get: __setFunctionName(function () { return this.#localFileName_accessor_storage; }, "#localFileName", "get"), set: __setFunctionName(function (value) { this.#localFileName_accessor_storage = value; }, "#localFileName", "set") }, _private_localFileName_decorators, { kind: "accessor", name: "#localFileName", static: false, private: true, access: { has: obj => #localFileName in obj, get: obj => obj.#localFileName, set: (obj, value) => { obj.#localFileName = value; } }, metadata: _metadata }, _private_localFileName_initializers, _private_localFileName_extraInitializers);
            __esDecorate(this, _private_toastMessage_descriptor = { get: __setFunctionName(function () { return this.#toastMessage_accessor_storage; }, "#toastMessage", "get"), set: __setFunctionName(function (value) { this.#toastMessage_accessor_storage = value; }, "#toastMessage", "set") }, _private_toastMessage_decorators, { kind: "accessor", name: "#toastMessage", static: false, private: true, access: { has: obj => #toastMessage in obj, get: obj => obj.#toastMessage, set: (obj, value) => { obj.#toastMessage = value; } }, metadata: _metadata }, _private_toastMessage_initializers, _private_toastMessage_extraInitializers);
            __esDecorate(this, _private_toastType_descriptor = { get: __setFunctionName(function () { return this.#toastType_accessor_storage; }, "#toastType", "get"), set: __setFunctionName(function (value) { this.#toastType_accessor_storage = value; }, "#toastType", "set") }, _private_toastType_decorators, { kind: "accessor", name: "#toastType", static: false, private: true, access: { has: obj => #toastType in obj, get: obj => obj.#toastType, set: (obj, value) => { obj.#toastType = value; } }, metadata: _metadata }, _private_toastType_initializers, _private_toastType_extraInitializers);
            __esDecorate(this, null, _snackbar_decorators, { kind: "accessor", name: "snackbar", static: false, private: false, access: { has: obj => "snackbar" in obj, get: obj => obj.snackbar, set: (obj, value) => { obj.snackbar = value; } }, metadata: _metadata }, _snackbar_initializers, _snackbar_extraInitializers);
            __esDecorate(null, _classDescriptor = { value: _classThis }, _classDecorators, { kind: "class", name: _classThis.name, metadata: _metadata }, null, _classExtraInitializers);
            A2UILayoutEditor = _classThis = _classDescriptor.value;
            if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        }
        #markdownRenderer_accessor_storage = __runInitializers(this, _markdownRenderer_initializers, (value, options) => {
        ...
        #isLocalMode_accessor_storage = __runInitializers(this, _private_isLocalMode_initializers, false);
        get #isLocalMode() { return _private_isLocalMode_descriptor.get.call(this); }
        set #isLocalMode(value) { return _private_isLocalMode_descriptor.set.call(this, value); }
        #localFileName_accessor_storage = (__runInitializers(this, _private_isLocalMode_extraInitializers), __runInitializers(this, _private_localFileName_initializers, ''));
        get #localFileName() { return _private_localFileName_descriptor.get.call(this); }
        set #localFileName(value) { return _private_localFileName_descriptor.set.call(this, value); }
        #toastMessage_accessor_storage = (__runInitializers(this, _private_localFileName_extraInitializers), __runInitializers(this, _private_toastMessage_initializers, ''));
        get #toastMessage() { return _private_toastMessage_descriptor.get.call(this); }
        set #toastMessage(value) { return _private_toastMessage_descriptor.set.call(this, value); }
        #toastType_accessor_storage = (__runInitializers(this, _private_toastMessage_extraInitializers), __runInitializers(this, _private_toastType_initializers, 'info'));
        get #toastType() { return _private_toastType_descriptor.get.call(this); }
        set #toastType(value) { return _private_toastType_descriptor.set.call(this, value); }
        #toastTimeout = __runInitializers(this, _private_toastType_extraInitializers);
        static { this.styles = [
            css `
      * {
    ...
    `,
        ...
        #snackbar_accessor_storage = __runInitializers(this, _snackbar_initializers, void 0);
        get snackbar() { return this.#snackbar_accessor_storage; }
        set snackbar(value) { this.#snackbar_accessor_storage = value; }
        #pendingSnackbarMessages = (__runInitializers(this, _snackbar_extraInitializers), []);
        #error;
        #maybeRenderError() {
            if (!this.#error)
                return nothing;
    ...
    >
      ...
      ${repeat(surfaces, ([surfaceId]) => surfaceId, ([_, surface]) => {
        ...
        #triggerFileUpload() {
            const fileInput = this.shadowRoot?.getElementById('local-file-input');
            if (fileInput) {
                fileInput.click();
            }
        }
        #onLocalFileChange(evt) {
            ...
            reader.onload = e => {
                try {
                    ...
                    console.error(err);
                    this.showToast(`Failed to parse A2UI JSON: ${err instanceof Error ? err.message : String(err)}`, 'error');
                }
            };
        ...
        async #loadBuiltinSample(filename) {
            try {
                ...
                console.error(err);
                this.showToast(`Failed to load sample JSON: ${err instanceof Error ? err.message : String(err)}`, 'error');
            }
        }
        #renderToast() {
