import "./chunk-Z7V5O43P.js";
import {
  external_exports
} from "./chunk-C6J3S4CR.js";
import {
  require_jsx_runtime
...
// ../../../../renderers/react/dist/chunk-MSVIM4WN.js
var import_react = __toESM(require_react(), 1);

// ../../../../renderers/web_core/dist/src/v0_8/schema/common-types.js
...
var DataValueSchema = createDataValueSchema();
...
var ImageSchema = external_exports.object({
  ...
  usageHint: external_exports.enum(["icon", "avatar", "smallFeature", "mediumFeature", "largeFeature", "header"]).optional(),
...
var TextFieldSchema = external_exports.object({
  ...
  textFieldType: external_exports.enum(["shortText", "number", "date", "longText", "obscured"]).optional(),
...
var RowSchema = external_exports.object({
  ...
  distribution: external_exports.enum(["start", "center", "end", "spaceBetween", "spaceAround", "spaceEvenly"]).optional(),
...
// ../../../../renderers/web_core/dist/src/v0_8/schema/server-to-client.js
    ...
    switch (componentType) {
      ...
      case "List":
        if (properties.children && !Array.isArray(properties.children)) {
          ...
          if (hasTemplate)
            checkRefs([(_a3 = properties.children.template) == null ? void 0 : _a3.componentId], component.id);
        }
        break;
      case "Card":
        if (properties.child)
...
// ../../../../renderers/web_core/dist/src/v0_8/errors.js
...
// ../../../../renderers/web_core/dist/src/v0_8/data/guards.js
...
// ../../../../renderers/web_core/dist/src/v0_8/data/model-processor.js
...
// ../../../../renderers/react/node_modules/clsx/dist/clsx.mjs
function r(e) {
  var t, f, n = "";
...
// ../../../../renderers/web_core/dist/src/v0_8/styles/behavior.js
var opacityBehavior = `
  &:not([disabled]) {
    cursor: pointer;
...
// ../../../../renderers/web_core/dist/src/v0_8/styles/shared.js
var grid = 4;

// ../../../../renderers/web_core/dist/src/v0_8/styles/border.js
var border = `
...
// ../../../../renderers/web_core/dist/src/v0_8/types/colors.js
var shades = [
  0,
  5,
  10,
...
// ../../../../renderers/web_core/dist/src/v0_8/styles/utils.js
...
// ../../../../renderers/web_core/dist/src/v0_8/styles/colors.js
var color = (src) => `
    ${src.map((key) => {
...
// ../../../../renderers/web_core/dist/src/v0_8/styles/icons.js
var icons = `
  .g-icon {
...
// ../../../../renderers/web_core/dist/src/v0_8/styles/layout.js
var layout = `
  :host {
...
// ../../../../renderers/web_core/dist/src/v0_8/styles/opacity.js
var opacity = `
  ${new Array(21).fill(0).map((_, idx) => {
...
// ../../../../renderers/web_core/dist/src/v0_8/styles/type.js
var type = `
  :host {
...
// ../../../../renderers/web_core/dist/src/v0_8/styles/index.js
var structuralStyles = [behavior, border, colors, icons, layout, opacity, type].flat(Infinity).join("\n");

// ../../../../renderers/react/node_modules/markdown-it/lib/common/utils.mjs
var utils_exports = {};
...
// ../../../../renderers/react/node_modules/mdurl/index.mjs
var mdurl_exports = {};
...
// ../../../../renderers/react/node_modules/mdurl/lib/decode.mjs
var decodeCache = {};
...
// ../../../../renderers/react/node_modules/mdurl/lib/encode.mjs
var encodeCache = {};
...
// ../../../../renderers/react/node_modules/mdurl/lib/format.mjs
function format(url) {
  let result = "";
  result += url.protocol || "";
  result += url.slashes ? "//" : "";
...
// ../../../../renderers/react/node_modules/mdurl/lib/parse.mjs
function Url() {
  this.protocol = null;
  this.slashes = null;
  this.auth = null;
...
// ../../../../renderers/react/node_modules/uc.micro/index.mjs
var uc_exports = {};
__export(uc_exports, {
  Any: () => regex_default,
  Cc: () => regex_default2,
...
// ../../../../renderers/react/node_modules/uc.micro/properties/Any/regex.mjs
var regex_default = /[\0-\uD7FF\uE000-\uFFFF]|[\uD800-\uDBFF][\uDC00-\uDFFF]|[\uD800-\uDBFF](?![\uDC00-\uDFFF])|(?:[^\uD800-\uDBFF]|^)[\uDC00-\uDFFF]/;

// ../../../../renderers/react/node_modules/uc.micro/categories/Cc/regex.mjs
var regex_default2 = /[\0-\x1F\x7F-\x9F]/;

// ../../../../renderers/react/node_modules/uc.micro/categories/Cf/regex.mjs
var regex_default3 = /[\xAD\u0600-\u0605\u061C\u06DD\u070F\u0890\u0891\u08E2\u180E\u200B-\u200F\u202A-\u202E\u2060-\u2064\u2066-\u206F\uFEFF\uFFF9-\uFFFB]|\uD804[\uDCBD\uDCCD]|\uD80D[\uDC30-\uDC3F]|\uD82F[\uDCA0-\uDCA3]|\uD834[\uDD73-\uDD7A]|\uDB40[\uDC01\uDC20-\uDC7F]/;

// ../../../../renderers/react/node_modules/uc.micro/categories/P/regex.mjs
var regex_default4 = /[!-#%-\*,-\/:;\?@\[-\]_\{\}\xA1\xA7\xAB\xB6\xB7\xBB\xBF\u037E\u0387\u055A-\u055F\u0589\u058A\u05BE\u05C0\u05C3\u05C6\u05F3\u05F4\u0609\u060A\u060C\u060D\u061B\u061D-\u061F\u066A-\u066D\u06D4\u0700-\u070D\u07F7-\u07F9\u0830-\u083E\u085E\u0964\u0965\u0970\u09FD\u0A76\u0AF0\u0C77\u0C84\u0DF4\u0E4F\u0E5A\u0E5B\u0F04-\u0F12\u0F14\u0F3A-\u0F3D\u0F85\u0FD0-\u0FD4\u0FD9\u0FDA\u104A-\u104F\u10FB\u1360-\u1368\u1400\u166E\u169B\u169C\u16EB-\u16ED\u1735\u1736\u17D4-\u17D6\u17D8-\u17DA\u1800-\u180A\u1944\u1945\u1A1E\u1A1F\u1AA0-\u1AA6\u1AA8-\u1AAD\u1B5A-\u1B60\u1B7D\u1B7E\u1BFC-\u1BFF\u1C3B-\u1C3F\u1C7E\u1C7F\u1CC0-\u1CC7\u1CD3\u2010-\u2027\u2030-\u2043\u2045-\u2051\u2053-\u205E\u207D\u207E\u208D\u208E\u2308-\u230B\u2329\u232A\u2768-\u2775\u27C5\u27C6\u27E6-\u27EF\u2983-\u2998\u29D8-\u29DB\u29FC\u29FD\u2CF9-\u2CFC\u2CFE\u2CFF\u2D70\u2E00-\u2E2E\u2E30-\u2E4F\u2E52-\u2E5D\u3001-\u3003\u3008-\u3011\u3014-\u301F\u3030\u303D\u30A0\u30FB\uA4FE\uA4FF\uA60D-\uA60F\uA673\uA67E\uA6F2-\uA6F7\uA874-\uA877\uA8CE\uA8CF\uA8F8-\uA8FA\uA8FC\uA92E\uA92F\uA95F\uA9C1-\uA9CD\uA9DE\uA9DF\uAA5C-\uAA5F\uAADE\uAADF\uAAF0\uAAF1\uABEB\uFD3E\uFD3F\uFE10-\uFE19\uFE30-\uFE52\uFE54-\uFE61\uFE63\uFE68\uFE6A\uFE6B\uFF01-\uFF03\uFF05-\uFF0A\uFF0C-\uFF0F\uFF1A\uFF1B\uFF1F\uFF20\uFF3B-\uFF3D\uFF3F\uFF5B\uFF5D\uFF5F-\uFF65]|\uD800[\uDD00-\uDD02\uDF9F\uDFD0]|\uD801\uDD6F|\uD802[\uDC57\uDD1F\uDD3F\uDE50-\uDE58\uDE7F\uDEF0-\uDEF6\uDF39-\uDF3F\uDF99-\uDF9C]|\uD803[\uDEAD\uDF55-\uDF59\uDF86-\uDF89]|\uD804[\uDC47-\uDC4D\uDCBB\uDCBC\uDCBE-\uDCC1\uDD40-\uDD43\uDD74\uDD75\uDDC5-\uDDC8\uDDCD\uDDDB\uDDDD-\uDDDF\uDE38-\uDE3D\uDEA9]|\uD805[\uDC4B-\uDC4F\uDC5A\uDC5B\uDC5D\uDCC6\uDDC1-\uDDD7\uDE41-\uDE43\uDE60-\uDE6C\uDEB9\uDF3C-\uDF3E]|\uD806[\uDC3B\uDD44-\uDD46\uDDE2\uDE3F-\uDE46\uDE9A-\uDE9C\uDE9E-\uDEA2\uDF00-\uDF09]|\uD807[\uDC41-\uDC45\uDC70\uDC71\uDEF7\uDEF8\uDF43-\uDF4F\uDFFF]|\uD809[\uDC70-\uDC74]|\uD80B[\uDFF1\uDFF2]|\uD81A[\uDE6E\uDE6F\uDEF5\uDF37-\uDF3B\uDF44]|\uD81B[\uDE97-\uDE9A\uDFE2]|\uD82F\uDC9F|\uD836[\uDE87-\uDE8B]|\uD83A[\uDD5E\uDD5F]/;

// ../../../../renderers/react/node_modules/uc.micro/categories/S/regex.mjs
var regex_default5 = /[\$\+<->\^`\|~\xA2-\xA6\xA8\xA9\xAC\xAE-\xB1\xB4\xB8\xD7\xF7\u02C2-\u02C5\u02D2-\u02DF\u02E5-\u02EB\u02ED\u02EF-\u02FF\u0375\u0384\u0385\u03F6\u0482\u058D-\u058F\u0606-\u0608\u060B\u060E\u060F\u06DE\u06E9\u06FD\u06FE\u07F6\u07FE\u07FF\u0888\u09F2\u09F3\u09FA\u09FB\u0AF1\u0B70\u0BF3-\u0BFA\u0C7F\u0D4F\u0D79\u0E3F\u0F01-\u0F03\u0F13\u0F15-\u0F17\u0F1A-\u0F1F\u0F34\u0F36\u0F38\u0FBE-\u0FC5\u0FC7-\u0FCC\u0FCE\u0FCF\u0FD5-\u0FD8\u109E\u109F\u1390-\u1399\u166D\u17DB\u1940\u19DE-\u19FF\u1B61-\u1B6A\u1B74-\u1B7C\u1FBD\u1FBF-\u1FC1\u1FCD-\u1FCF\u1FDD-\u1FDF\u1FED-\u1FEF\u1FFD\u1FFE\u2044\u2052\u207A-\u207C\u208A-\u208C\u20A0-\u20C0\u2100\u2101\u2103-\u2106\u2108\u2109\u2114\u2116-\u2118\u211E-\u2123\u2125\u2127\u2129\u212E\u213A\u213B\u2140-\u2144\u214A-\u214D\u214F\u218A\u218B\u2190-\u2307\u230C-\u2328\u232B-\u2426\u2440-\u244A\u249C-\u24E9\u2500-\u2767\u2794-\u27C4\u27C7-\u27E5\u27F0-\u2982\u2999-\u29D7\u29DC-\u29FB\u29FE-\u2B73\u2B76-\u2B95\u2B97-\u2BFF\u2CE5-\u2CEA\u2E50\u2E51\u2E80-\u2E99\u2E9B-\u2EF3\u2F00-\u2FD5\u2FF0-\u2FFF\u3004\u3012\u3013\u3020\u3036\u3037\u303E\u303F\u309B\u309C\u3190\u3191\u3196-\u319F\u31C0-\u31E3\u31EF\u3200-\u321E\u322A-\u3247\u3250\u3260-\u327F\u328A-\u32B0\u32C0-\u33FF\u4DC0-\u4DFF\uA490-\uA4C6\uA700-\uA716\uA720\uA721\uA789\uA78A\uA828-\uA82B\uA836-\uA839\uAA77-\uAA79\uAB5B\uAB6A\uAB6B\uFB29\uFBB2-\uFBC2\uFD40-\uFD4F\uFDCF\uFDFC-\uFDFF\uFE62\uFE64-\uFE66\uFE69\uFF04\uFF0B\uFF1C-\uFF1E\uFF3E\uFF40\uFF5C\uFF5E\uFFE0-\uFFE6\uFFE8-\uFFEE\uFFFC\uFFFD]|\uD800[\uDD37-\uDD3F\uDD79-\uDD89\uDD8C-\uDD8E\uDD90-\uDD9C\uDDA0\uDDD0-\uDDFC]|\uD802[\uDC77\uDC78\uDEC8]|\uD805\uDF3F|\uD807[\uDFD5-\uDFF1]|\uD81A[\uDF3C-\uDF3F\uDF45]|\uD82F\uDC9C|\uD833[\uDF50-\uDFC3]|\uD834[\uDC00-\uDCF5\uDD00-\uDD26\uDD29-\uDD64\uDD6A-\uDD6C\uDD83\uDD84\uDD8C-\uDDA9\uDDAE-\uDDEA\uDE00-\uDE41\uDE45\uDF00-\uDF56]|\uD835[\uDEC1\uDEDB\uDEFB\uDF15\uDF35\uDF4F\uDF6F\uDF89\uDFA9\uDFC3]|\uD836[\uDC00-\uDDFF\uDE37-\uDE3A\uDE6D-\uDE74\uDE76-\uDE83\uDE85\uDE86]|\uD838[\uDD4F\uDEFF]|\uD83B[\uDCAC\uDCB0\uDD2E\uDEF0\uDEF1]|\uD83C[\uDC00-\uDC2B\uDC30-\uDC93\uDCA0-\uDCAE\uDCB1-\uDCBF\uDCC1-\uDCCF\uDCD1-\uDCF5\uDD0D-\uDDAD\uDDE6-\uDE02\uDE10-\uDE3B\uDE40-\uDE48\uDE50\uDE51\uDE60-\uDE65\uDF00-\uDFFF]|\uD83D[\uDC00-\uDED7\uDEDC-\uDEEC\uDEF0-\uDEFC\uDF00-\uDF76\uDF7B-\uDFD9\uDFE0-\uDFEB\uDFF0]|\uD83E[\uDC00-\uDC0B\uDC10-\uDC47\uDC50-\uDC59\uDC60-\uDC87\uDC90-\uDCAD\uDCB0\uDCB1\uDD00-\uDE53\uDE60-\uDE6D\uDE70-\uDE7C\uDE80-\uDE88\uDE90-\uDEBD\uDEBF-\uDEC5\uDECE-\uDEDB\uDEE0-\uDEE8\uDEF0-\uDEF8\uDF00-\uDF92\uDF94-\uDFCA]/;

// ../../../../renderers/react/node_modules/uc.micro/categories/Z/regex.mjs
var regex_default6 = /[ \xA0\u1680\u2000-\u200A\u2028\u2029\u202F\u205F\u3000]/;

// ../../../../renderers/react/node_modules/entities/lib/esm/generated/decode-data-html.js
...
// ../../../../renderers/react/node_modules/entities/lib/esm/generated/decode-data-xml.js
var decode_data_xml_default = new Uint16Array(
  // prettier-ignore
  "Ȁaglq	\x1Bɭ\0\0p;䀦os;䀧t;䀾t;䀼uot;䀢".split("").map((c) => c.charCodeAt(0))
);

// ../../../../renderers/react/node_modules/entities/lib/esm/decode_codepoint.js
var _a;
...
// ../../../../renderers/react/node_modules/entities/lib/esm/decode.js
var CharCodes;
(function(CharCodes2) {
...
// ../../../../renderers/react/node_modules/entities/lib/esm/generated/encode-html.js
...
// ../../../../renderers/react/node_modules/entities/lib/esm/escape.js
...
// ../../../../renderers/react/node_modules/entities/lib/esm/index.js
var EntityLevel;
...
// ../../../../renderers/react/node_modules/markdown-it/lib/helpers/index.mjs
var helpers_exports = {};
...
// ../../../../renderers/react/node_modules/markdown-it/lib/helpers/parse_link_label.mjs
...
// ../../../../renderers/react/node_modules/markdown-it/lib/helpers/parse_link_destination.mjs
...
// ../../../../renderers/react/node_modules/markdown-it/lib/helpers/parse_link_title.mjs
...
// ../../../../renderers/react/node_modules/markdown-it/lib/renderer.mjs
var default_rules = {};
...
// ../../../../renderers/react/node_modules/markdown-it/lib/ruler.mjs
function Ruler() {
  this.__rules__ = [];
  this.__cache__ = null;
}
...
// ../../../../renderers/react/node_modules/markdown-it/lib/token.mjs
...
// ../../../../renderers/react/node_modules/markdown-it/lib/rules_core/state_core.mjs
...
// ../../../../renderers/react/node_modules/markdown-it/lib/rules_core/normalize.mjs
var NEWLINES_RE = /\r\n?|\n/g;
var NULL_RE = /\0/g;
...
// ../../../../renderers/react/node_modules/markdown-it/lib/rules_core/block.mjs
...
// ../../../../renderers/react/node_modules/markdown-it/lib/rules_core/inline.mjs
...
// ../../../../renderers/react/node_modules/markdown-it/lib/rules_core/linkify.mjs
...
// ../../../../renderers/react/node_modules/markdown-it/lib/rules_core/replacements.mjs
var RARE_RE = /\+-|\.\.|\?\?\?\?|!!!!|,,|--/;
...
// ../../../../renderers/react/node_modules/markdown-it/lib/rules_core/smartquotes.mjs
var QUOTE_TEST_RE = /['"]/;
var QUOTE_RE = /['"]/g;
var APOSTROPHE = "’";
...
// ../../../../renderers/react/node_modules/markdown-it/lib/rules_core/text_join.mjs
...
// ../../../../renderers/react/node_modules/markdown-it/lib/parser_core.mjs
var _rules = [
  ["normalize", normalize],
  ["block", block],
  ["inline", inline],
...
// ../../../../renderers/react/node_modules/markdown-it/lib/rules_block/state_block.mjs
...
// ../../../../renderers/react/node_modules/markdown-it/lib/rules_block/table.mjs
...
// ../../../../renderers/react/node_modules/markdown-it/lib/rules_block/code.mjs
...
// ../../../../renderers/react/node_modules/markdown-it/lib/rules_block/fence.mjs
...
// ../../../../renderers/react/node_modules/markdown-it/lib/rules_block/blockquote.mjs
...
// ../../../../renderers/react/node_modules/markdown-it/lib/rules_block/hr.mjs
...
// ../../../../renderers/react/node_modules/markdown-it/lib/rules_block/list.mjs
...
// ../../../../renderers/react/node_modules/markdown-it/lib/rules_block/reference.mjs
...
// ../../../../renderers/react/node_modules/markdown-it/lib/common/html_blocks.mjs
...
// ../../../../renderers/react/node_modules/markdown-it/lib/common/html_re.mjs
...
// ../../../../renderers/react/node_modules/markdown-it/lib/rules_block/html_block.mjs
var HTML_SEQUENCES = [
...
// ../../../../renderers/react/node_modules/markdown-it/lib/rules_block/heading.mjs
...
// ../../../../renderers/react/node_modules/markdown-it/lib/rules_block/lheading.mjs
...
// ../../../../renderers/react/node_modules/markdown-it/lib/rules_block/paragraph.mjs
...
// ../../../../renderers/react/node_modules/markdown-it/lib/parser_block.mjs
var _rules2 = [
...
// ../../../../renderers/react/node_modules/markdown-it/lib/rules_inline/state_inline.mjs
...
// ../../../../renderers/react/node_modules/markdown-it/lib/rules_inline/text.mjs
...
// ../../../../renderers/react/node_modules/markdown-it/lib/rules_inline/linkify.mjs
...
// ../../../../renderers/react/node_modules/markdown-it/lib/rules_inline/newline.mjs
...
// ../../../../renderers/react/node_modules/markdown-it/lib/rules_inline/escape.mjs
var ESCAPED = [];
for (let i = 0; i < 256; i++) {
  ESCAPED.push(0);
}
...
// ../../../../renderers/react/node_modules/markdown-it/lib/rules_inline/backticks.mjs
...
// ../../../../renderers/react/node_modules/markdown-it/lib/rules_inline/strikethrough.mjs
...
// ../../../../renderers/react/node_modules/markdown-it/lib/rules_inline/emphasis.mjs
...
// ../../../../renderers/react/node_modules/markdown-it/lib/rules_inline/link.mjs
...
// ../../../../renderers/react/node_modules/markdown-it/lib/rules_inline/image.mjs
...
// ../../../../renderers/react/node_modules/markdown-it/lib/rules_inline/autolink.mjs
...
// ../../../../renderers/react/node_modules/markdown-it/lib/rules_inline/html_inline.mjs
...
// ../../../../renderers/react/node_modules/markdown-it/lib/rules_inline/entity.mjs
...
// ../../../../renderers/react/node_modules/markdown-it/lib/rules_inline/balance_pairs.mjs
...
// ../../../../renderers/react/node_modules/markdown-it/lib/rules_inline/fragments_join.mjs
...
// ../../../../renderers/react/node_modules/markdown-it/lib/parser_inline.mjs
var _rules3 = [
  ["text", text],
  ["linkify", linkify2],
  ["newline", newline],
...
// ../../../../renderers/react/node_modules/linkify-it/lib/re.mjs
...
// ../../../../renderers/react/node_modules/linkify-it/index.mjs
...
// ../../../../renderers/react/node_modules/punycode.js/punycode.es6.js
...
// ../../../../renderers/react/node_modules/markdown-it/lib/presets/default.mjs
var default_default = {
  options: {
...
// ../../../../renderers/react/node_modules/markdown-it/lib/presets/zero.mjs
var zero_default = {
  options: {
    // Enable HTML tags in source
    html: false,
...
// ../../../../renderers/react/node_modules/markdown-it/lib/presets/commonmark.mjs
...
// ../../../../renderers/react/node_modules/markdown-it/lib/index.mjs
var config = {
...
function ThemeProvider({ theme, children }) {
  return (0, import_jsx_runtime.jsx)(ThemeContext.Provider, { value: theme ?? defaultTheme, children });
}
function useTheme() {
...
var _a2;
var ComponentRegistry = (_a2 = class {
  constructor() {
    __publicField(this, "registry", /* @__PURE__ */ new Map());
    __publicField(this, "lazyCache", /* @__PURE__ */ new Map());
  }
  /**
  ...
  static getInstance() {
    if (!_a2._instance) {
      _a2._instance = new _a2();
    }
    return _a2._instance;
  }
  /**
   ...
   */
  register(type2, registration) {
    this.registry.set(type2, registration);
  }
  /**
   ...
   */
  unregister(type2) {
    this.registry.delete(type2);
    this.lazyCache.delete(type2);
  }
  /**
   ...
   */
  has(type2) {
    return this.registry.has(type2);
  }
  /**
   ...
   */
  get(type2) {
    const registration = this.registry.get(type2);
    if (!registration) return null;
    if (registration.lazy && typeof registration.component === "function") {
      const cached = this.lazyCache.get(type2);
      if (cached) return cached;
      const lazyComponent = (0, import_react.lazy)(registration.component);
      this.lazyCache.set(type2, lazyComponent);
...
}, __publicField(_a2, "_instance", null), _a2);
function useA2UIComponent(node, surfaceId) {
  const actions = useA2UIActions();
  const theme = useTheme();
  const baseId = (0, import_react.useId)();
  useA2UIState();
  const resolveString = (0, import_react.useCallback)(
    (value) => {
  ...
  const resolveNumber = (0, import_react.useCallback)(
    (value) => {
      if (!value) return null;
      if (typeof value !== "object") return null;
  ...
  const resolveBoolean = (0, import_react.useCallback)(
    (value) => {
      if (!value) return null;
      if (typeof value !== "object") return null;
  ...
  const getUniqueId = (0, import_react.useCallback)(
    (prefix) => {
...
function renderWithTheme(text2, markdownTheme) {
  const appliedKeys = [];
  ...
  const html = markdownRenderer.render(text2);
  for (const key of appliedKeys) {
    delete markdownRenderer.renderer.rules[key];
  }
  return html;
}
var Text = (0, import_react.memo)(function Text2({ node, surfaceId }) {
  var _a3;
  ...
  const additionalStyles = (0, import_react.useMemo)(() => {
    var _a4;
    const textStyles = (_a4 = theme.additionalStyles) == null ? void 0 : _a4.Text;
  ...
  }, [(_a3 = theme.additionalStyles) == null ? void 0 : _a3.Text, usageHint]);
  const renderedContent = (0, import_react.useMemo)(() => {
  ...
  return (0, import_jsx_runtime.jsx)("div", { className: "a2ui-text", style: hostStyle, children: (0, import_jsx_runtime.jsx)(
    "section",
    {
...
var Image = (0, import_react.memo)(function Image2({ node, surfaceId }) {
  var _a3;
  const { theme, resolveString } = useA2UIComponent(node, surfaceId);
  const props = node.properties;
  ...
  const style = {
    ...stylesToObject((_a3 = theme.additionalStyles) == null ? void 0 : _a3.Image),
    "--object-fit": fit
  };
  if (!url) {
    return null;
  ...
  const hostStyle = node.weight !== void 0 ? { "--weight": node.weight } : {};
  return (0, import_jsx_runtime.jsx)("div", { className: "a2ui-image", style: hostStyle, children: (0, import_jsx_runtime.jsx)("section", { className: classMapToString(classes), style, children: (0, import_jsx_runtime.jsx)("img", { src: url, alt: altText || "" }) }) });
});
function toSnakeCase(str) {
  return str.replace(/([A-Z])/g, "_$1").toLowerCase();
}
var Icon = (0, import_react.memo)(function Icon2({ node, surfaceId }) {
  var _a3;
  const { theme, resolveString } = useA2UIComponent(node, surfaceId);
  const props = node.properties;
  ...
  const hostStyle = node.weight !== void 0 ? { "--weight": node.weight } : {};
  return (0, import_jsx_runtime.jsx)("div", { className: "a2ui-icon", style: hostStyle, children: (0, import_jsx_runtime.jsx)(
    "section",
    {
      className: classMapToString(theme.components.Icon),
      style: stylesToObject((_a3 = theme.additionalStyles) == null ? void 0 : _a3.Icon),
      children: (0, import_jsx_runtime.jsx)("span", { className: "g-icon", children: snakeCaseName })
    }
  ) });
});
var Divider = (0, import_react.memo)(function Divider2({
  node,
  surfaceId
}) {
  var _a3;
  ...
  const hostStyle = node.weight !== void 0 ? { "--weight": node.weight } : {};
  return (0, import_jsx_runtime.jsx)("div", { className: "a2ui-divider", style: hostStyle, children: (0, import_jsx_runtime.jsx)(
    "hr",
    {
      className: classMapToString(theme.components.Divider),
      style: stylesToObject((_a3 = theme.additionalStyles) == null ? void 0 : _a3.Divider)
    }
  ) });
});
...
var Video = (0, import_react.memo)(function Video2({ node, surfaceId }) {
  var _a3;
  const { theme, resolveString } = useA2UIComponent(node, surfaceId);
  const props = node.properties;
  const url = resolveString(props.url);
  ...
  const hostStyle = node.weight !== void 0 ? { "--weight": node.weight } : {};
  return (0, import_jsx_runtime.jsx)("div", { className: "a2ui-video", style: hostStyle, children: (0, import_jsx_runtime.jsx)(
    "section",
    {
      className: classMapToString(theme.components.Video),
      style: stylesToObject((_a3 = theme.additionalStyles) == null ? void 0 : _a3.Video),
      children: youtubeId ? (0, import_jsx_runtime.jsx)(
        "iframe",
        {
      ...
      ) : (0, import_jsx_runtime.jsx)("video", { src: url, controls: true })
    }
  ) });
});
var AudioPlayer = (0, import_react.memo)(function AudioPlayer2({
  node,
  surfaceId
}) {
  var _a3;
  ...
  const hostStyle = node.weight !== void 0 ? { "--weight": node.weight } : {};
  return (0, import_jsx_runtime.jsx)("div", { className: "a2ui-audio", style: hostStyle, children: (0, import_jsx_runtime.jsxs)(
    "section",
    {
      className: classMapToString(theme.components.AudioPlayer),
      style: stylesToObject((_a3 = theme.additionalStyles) == null ? void 0 : _a3.AudioPlayer),
      children: [
        description && (0, import_jsx_runtime.jsx)("p", { children: description }),
        (0, import_jsx_runtime.jsx)("audio", { src: url, controls: true })
      ]
    }
  ) });
});
var LoadingFallback = (0, import_react.memo)(function LoadingFallback2() {
  return (0, import_jsx_runtime.jsx)("div", { className: "a2ui-loading", style: { padding: "8px", opacity: 0.5 }, children: "Loading..." });
});
var ComponentNode = (0, import_react.memo)(function ComponentNode2({
  node,
  surfaceId,
  registry
}) {
  ...
  return (0, import_jsx_runtime.jsx)(import_react.Suspense, { fallback: (0, import_jsx_runtime.jsx)(LoadingFallback, {}), children: (0, import_jsx_runtime.jsx)(Component, { node, surfaceId }) });
});
var Row = (0, import_react.memo)(function Row2({ node, surfaceId }) {
  var _a3;
  const { theme } = useA2UIComponent(node, surfaceId);
  const props = node.properties;
    ...
    "div",
    {
      ...
      children: (0, import_jsx_runtime.jsx)(
        "section",
        {
          ...
          style: stylesToObject((_a3 = theme.additionalStyles) == null ? void 0 : _a3.Row),
          children: children.map((child, index) => {
            ...
            return (0, import_jsx_runtime.jsx)(ComponentNode, { node: childNode, surfaceId }, childId);
          })
        }
      )
    }
...
var Column = (0, import_react.memo)(function Column2({
  node,
  surfaceId
}) {
  var _a3;
    ...
    "div",
    {
      ...
      children: (0, import_jsx_runtime.jsx)(
        "section",
        {
          ...
          style: stylesToObject((_a3 = theme.additionalStyles) == null ? void 0 : _a3.Column),
          children: children.map((child, index) => {
            const childId = typeof child === "object" && child !== null && "id" in child ? child.id : `child-${index}`;
            const childNode = typeof child === "object" && child !== null && "type" in child ? child : null;
            return (0, import_jsx_runtime.jsx)(ComponentNode, { node: childNode, surfaceId }, childId);
...
var List = (0, import_react.memo)(function List2({ node, surfaceId }) {
  var _a3;
  const { theme } = useA2UIComponent(node, surfaceId);
  const props = node.properties;
  ...
  const children = Array.isArray(props.children) ? props.children : [];
  const hostStyle = node.weight !== void 0 ? { "--weight": node.weight } : {};
  return (0, import_jsx_runtime.jsx)("div", { className: "a2ui-list", "data-direction": direction, style: hostStyle, children: (0, import_jsx_runtime.jsx)(
    "section",
    {
      className: classMapToString(theme.components.List),
      style: stylesToObject((_a3 = theme.additionalStyles) == null ? void 0 : _a3.List),
      children: children.map((child, index) => {
        const childId = typeof child === "object" && child !== null && "id" in child ? child.id : `child-${index}`;
        const childNode = typeof child === "object" && child !== null && "type" in child ? child : null;
        return (0, import_jsx_runtime.jsx)(ComponentNode, { node: childNode, surfaceId }, childId);
...
var Card = (0, import_react.memo)(function Card2({ node, surfaceId }) {
  var _a3;
  const { theme } = useA2UIComponent(node, surfaceId);
  const props = node.properties;
  ...
  const hostStyle = node.weight !== void 0 ? { "--weight": node.weight } : {};
  return (0, import_jsx_runtime.jsx)("div", { className: "a2ui-card", style: hostStyle, children: (0, import_jsx_runtime.jsx)(
    "section",
    {
      className: classMapToString(theme.components.Card),
      style: stylesToObject((_a3 = theme.additionalStyles) == null ? void 0 : _a3.Card),
      children: children.map((child, index) => {
        const childId = typeof child === "object" && child !== null && "id" in child ? child.id : `child-${index}`;
        const childNode = typeof child === "object" && child !== null && "type" in child ? child : null;
        return (0, import_jsx_runtime.jsx)(ComponentNode, { node: childNode, surfaceId }, childId);
...
var Tabs = (0, import_react.memo)(function Tabs2({ node, surfaceId }) {
  var _a3;
  const { theme, resolveString } = useA2UIComponent(node, surfaceId);
  const props = node.properties;
  ...
  const hostStyle = node.weight !== void 0 ? { "--weight": node.weight } : {};
  return (0, import_jsx_runtime.jsx)("div", { className: "a2ui-tabs", style: hostStyle, children: (0, import_jsx_runtime.jsxs)(
    "section",
    {
      className: classMapToString(theme.components.Tabs.container),
      style: stylesToObject((_a3 = theme.additionalStyles) == null ? void 0 : _a3.Tabs),
      children: [
        (0, import_jsx_runtime.jsx)("div", { id: "buttons", className: classMapToString(theme.components.Tabs.element), children: tabItems.map((tab, index) => {
        ...
        tabItems[selectedIndex] && (0, import_jsx_runtime.jsx)(ComponentNode, { node: tabItems[selectedIndex].child, surfaceId })
      ]
    }
  ) });
});
var Modal = (0, import_react.memo)(function Modal2({ node, surfaceId }) {
  var _a3;
  const { theme } = useA2UIComponent(node, surfaceId);
  const props = node.properties;
  ...
  const hostStyle = node.weight !== void 0 ? { "--weight": node.weight } : {};
  if (!isOpen) {
    return (0, import_jsx_runtime.jsx)("div", { className: "a2ui-modal", style: hostStyle, children: (0, import_jsx_runtime.jsx)("section", { onClick: openModal, style: { cursor: "pointer" }, children: (0, import_jsx_runtime.jsx)(ComponentNode, { node: props.entryPointChild, surfaceId }) }) });
  }
  return (0, import_jsx_runtime.jsx)("div", { className: "a2ui-modal", style: hostStyle, children: (0, import_jsx_runtime.jsx)(
    "dialog",
    {
      ref: dialogRef,
      ...
      children: (0, import_jsx_runtime.jsxs)(
        "section",
        {
          ...
          style: stylesToObject((_a3 = theme.additionalStyles) == null ? void 0 : _a3.Modal),
          children: [
            (0, import_jsx_runtime.jsx)("div", { id: "controls", children: (0, import_jsx_runtime.jsx)("button", { onClick: closeModal, "aria-label": "Close modal", children: (0, import_jsx_runtime.jsx)("span", { className: "g-icon", children: "close" }) }) }),
            (0, import_jsx_runtime.jsx)(ComponentNode, { node: props.contentChild, surfaceId })
          ]
        }
      )
    }
...
var Button = (0, import_react.memo)(function Button2({
  node,
  surfaceId
}) {
  var _a3;
  ...
  const hostStyle = node.weight !== void 0 ? { "--weight": node.weight } : {};
  return (0, import_jsx_runtime.jsx)("div", { className: "a2ui-button", style: hostStyle, children: (0, import_jsx_runtime.jsx)(
    "button",
    {
      className: classMapToString(theme.components.Button),
      style: stylesToObject((_a3 = theme.additionalStyles) == null ? void 0 : _a3.Button),
      onClick: handleClick,
      children: (0, import_jsx_runtime.jsx)(ComponentNode, { node: props.child, surfaceId })
    }
  ) });
});
var TextField = (0, import_react.memo)(function TextField2({
  node,
  surfaceId
}) {
  var _a3, _b, _c;
  ...
  const textPath = (_a3 = props.text) == null ? void 0 : _a3.path;
  ...
  const [value, setLocalValue] = (0, import_react.useState)(initialValue);
  const [_isValid, setIsValid] = (0, import_react.useState)(true);
  (0, import_react.useEffect)(() => {
    if (textPath) {
  ...
  const hostStyle = node.weight !== void 0 ? { "--weight": node.weight } : {};
  return (0, import_jsx_runtime.jsx)("div", { className: "a2ui-textfield", style: hostStyle, children: (0, import_jsx_runtime.jsxs)("section", { className: classMapToString(theme.components.TextField.container), children: [
    label && (0, import_jsx_runtime.jsx)("label", { htmlFor: id, className: classMapToString(theme.components.TextField.label), children: label }),
    isTextArea ? (0, import_jsx_runtime.jsx)(
      "textarea",
      {
        id,
        value,
        ...
        style: stylesToObject((_b = theme.additionalStyles) == null ? void 0 : _b.TextField)
      }
      ...
      "input",
      {
        ...
        placeholder: "Please enter a value",
        className: classMapToString(theme.components.TextField.element),
        style: stylesToObject((_c = theme.additionalStyles) == null ? void 0 : _c.TextField)
      }
    )
  ] }) });
});
var CheckBox = (0, import_react.memo)(function CheckBox2({
  node,
  surfaceId
}) {
  var _a3, _b, _c;
  ...
  const id = (0, import_react.useId)();
  const label = resolveString(props.label);
  const valuePath = (_a3 = props.value) == null ? void 0 : _a3.path;
  const initialChecked = resolveBoolean(props.value) ?? false;
  const [checked, setChecked] = (0, import_react.useState)(initialChecked);
  (0, import_react.useEffect)(() => {
    if (valuePath) {
  ...
  (0, import_react.useEffect)(() => {
    var _a4;
    if (((_a4 = props.value) == null ? void 0 : _a4.literalBoolean) !== void 0) {
      setChecked(props.value.literalBoolean);
    }
  }, [(_b = props.value) == null ? void 0 : _b.literalBoolean]);
  const handleChange = (0, import_react.useCallback)(
    (e) => {
  ...
  const hostStyle = node.weight !== void 0 ? { "--weight": node.weight } : {};
  return (0, import_jsx_runtime.jsx)("div", { className: "a2ui-checkbox", style: hostStyle, children: (0, import_jsx_runtime.jsxs)(
    "section",
    {
      className: classMapToString(theme.components.CheckBox.container),
      style: stylesToObject((_c = theme.additionalStyles) == null ? void 0 : _c.CheckBox),
      children: [
        (0, import_jsx_runtime.jsx)(
          "input",
          {
        ...
        label && (0, import_jsx_runtime.jsx)("label", { htmlFor: id, className: classMapToString(theme.components.CheckBox.label), children: label })
      ]
    }
  ) });
});
var Slider = (0, import_react.memo)(function Slider2({
  node,
  surfaceId
}) {
  var _a3, _b, _c;
  ...
  (0, import_react.useEffect)(() => {
    var _a4;
    if (((_a4 = props.value) == null ? void 0 : _a4.literalNumber) !== void 0) {
      setLocalValue(props.value.literalNumber);
    }
  }, [(_b = props.value) == null ? void 0 : _b.literalNumber]);
  const handleChange = (0, import_react.useCallback)(
    (e) => {
  ...
  const hostStyle = node.weight !== void 0 ? { "--weight": node.weight } : {};
  return (0, import_jsx_runtime.jsx)("div", { className: "a2ui-slider", style: hostStyle, children: (0, import_jsx_runtime.jsxs)("section", { className: classMapToString(theme.components.Slider.container), children: [
    label && (0, import_jsx_runtime.jsx)("label", { htmlFor: id, className: classMapToString(theme.components.Slider.label), children: label }),
    (0, import_jsx_runtime.jsx)(
      "input",
      {
        type: "range",
        ...
        style: stylesToObject((_c = theme.additionalStyles) == null ? void 0 : _c.Slider)
      }
    ),
    (0, import_jsx_runtime.jsx)("span", { className: classMapToString(theme.components.Slider.label), children: value })
  ] }) });
});
var DateTimeInput = (0, import_react.memo)(function DateTimeInput2({
  node,
  surfaceId
}) {
  var _a3, _b;
  ...
  const hostStyle = node.weight !== void 0 ? { "--weight": node.weight } : {};
  return (0, import_jsx_runtime.jsx)("div", { className: "a2ui-datetime-input", style: hostStyle, children: (0, import_jsx_runtime.jsxs)("section", { className: classMapToString(theme.components.DateTimeInput.container), children: [
    (0, import_jsx_runtime.jsx)("label", { htmlFor: id, className: classMapToString(theme.components.DateTimeInput.label), children: getPlaceholderText() }),
    (0, import_jsx_runtime.jsx)(
      "input",
      {
        type: inputType,
        ...
        style: stylesToObject((_b = theme.additionalStyles) == null ? void 0 : _b.DateTimeInput)
      }
    )
  ] }) });
});
var MultipleChoice = (0, import_react.memo)(function MultipleChoice2({
  node,
  surfaceId
}) {
  var _a3, _b;
  ...
  const selectionsPath = (_a3 = props.selections) == null ? void 0 : _a3.path;
  ...
  const hostStyle = node.weight !== void 0 ? { "--weight": node.weight } : {};
  return (0, import_jsx_runtime.jsx)("div", { className: "a2ui-multiplechoice", style: hostStyle, children: (0, import_jsx_runtime.jsxs)("section", { className: classMapToString(theme.components.MultipleChoice.container), children: [
    (0, import_jsx_runtime.jsx)("label", { htmlFor: id, className: classMapToString(theme.components.MultipleChoice.label), children: description }),
    (0, import_jsx_runtime.jsx)(
      "select",
      {
        name: "data",
        ...
        style: stylesToObject((_b = theme.additionalStyles) == null ? void 0 : _b.MultipleChoice),
        onChange: handleChange,
        children: options.map((option) => {
          const label = resolveString(option.label);
          return (0, import_jsx_runtime.jsx)("option", { value: option.value, children: label }, option.value);
        })
      }
    )
  ] }) });
...
`;
var structuralStyles2 = structuralStyles.replace(
  /:host\s*\{/g,
  ".a2ui-surface {"
);
...
var A2UIActionsContext = (0, import_react.createContext)(null);
var A2UIStateContext = (0, import_react.createContext)(null);
function A2UIProvider({ onAction, theme, children }) {
  ...
  const onActionRef = (0, import_react.useRef)(onAction ?? null);
  ...
  const stateValue = (0, import_react.useMemo)(() => ({ version }), [version]);
  return (0, import_jsx_runtime.jsx)(A2UIActionsContext.Provider, { value: actions, children: (0, import_jsx_runtime.jsx)(A2UIStateContext.Provider, { value: stateValue, children: (0, import_jsx_runtime.jsx)(ThemeProvider, { theme, children }) }) });
}
function useA2UIActions() {
  const actions = (0, import_react.useContext)(A2UIActionsContext);
  if (!actions) {
...
function useA2UIState() {
  const state = (0, import_react.useContext)(A2UIStateContext);
  if (!state) {
...
var DefaultLoadingFallback = (0, import_react.memo)(function DefaultLoadingFallback2() {
  return (0, import_jsx_runtime.jsx)("div", { className: "a2ui-loading", style: { padding: "16px", opacity: 0.5 }, children: "Loading..." });
});
var A2UIRenderer = (0, import_react.memo)(function A2UIRenderer2({
  surfaceId,
  className,
  fallback = null,
  loadingFallback,
  ...
  const surfaceStyles = (0, import_react.useMemo)(() => {
    if (!(surface == null ? void 0 : surface.styles)) return {};
    const styles = {};
    ...
    return styles;
  }, [surface == null ? void 0 : surface.styles]);
  if (!surface || !surface.componentTree) {
    return (0, import_jsx_runtime.jsx)(import_jsx_runtime.Fragment, { children: fallback });
  }
  const actualLoadingFallback = loadingFallback ?? (0, import_jsx_runtime.jsx)(DefaultLoadingFallback, {});
  return (0, import_jsx_runtime.jsx)(
    "div",
    {
      ...
      children: (0, import_jsx_runtime.jsx)(import_react.Suspense, { fallback: actualLoadingFallback, children: (0, import_jsx_runtime.jsx)(ComponentNode, { node: surface.componentTree, surfaceId, registry }) })
    }
  );
});
function A2UIViewer({
  ...
  const baseId = (0, import_react.useId)();
  const surfaceId = (0, import_react.useMemo)(() => {
  ...
  const handleAction = (0, import_react.useMemo)(() => {
  ...
  return (0, import_jsx_runtime.jsx)(A2UIProvider, { onAction: handleAction, theme, children: (0, import_jsx_runtime.jsx)(
    A2UIViewerInner,
    {
      surfaceId,
      root,
...
function A2UIViewerInner({
  ...
  const lastProcessedRef = (0, import_react.useRef)("");
  (0, import_react.useEffect)(() => {
  ...
  return (0, import_jsx_runtime.jsx)("div", { className, children: (0, import_jsx_runtime.jsx)(A2UIRenderer, { surfaceId }) });
}
...
//# sourceMappingURL=@a2ui_react.js.map
